...
//  ConvertIt
//
//  Created by Tram Nguyen on 3/11/18.
...
class ViewController: UIViewController {
    ...
    func calculateConversion() {
        ...
        let formatString = (decimalSegment.selectedSegmentIndex <
            decimalSegment.numberOfSegments - 1 ? "%.\(decimalSegment.selectedSegmentIndex+1)f" : "%f")
